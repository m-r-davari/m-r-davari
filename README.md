...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/f1_github_meme_dark.gif">
  <img alt="Text changing depending on mode. Light: 'LighMeme' Dark: 'DarkMeme'" src="./assets/f1_github_meme_light.gif" width="100%">
</picture>
